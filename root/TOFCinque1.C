...
# include </usr/share/root/include/TApplication.h>
# include </usr/share/root/include/TGClient.h>
...
TROOT root("GUI","GUI hope environment",initfuncs);

void main(int argc, char **argv)
{
  TApplication theApp("App",&argc,argv);
//  mainWin MyMainFrame =new mainWin(gClient->GetRoot(),200,220);
