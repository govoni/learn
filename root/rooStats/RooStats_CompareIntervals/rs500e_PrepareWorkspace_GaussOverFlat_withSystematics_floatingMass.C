...
void rs500e_PrepareWorkspace_GaussOverFlat_withSystematics_floatingMass( TString fileName = "WS_GaussOverFlat_withSystematics_floatingMass.root", int type = 1 )
{
