// @(#)root/tmva $Id: Tools.h,v 1.8 2008/07/20 20:44:28 stelzer Exp $   
...
namespace TMVA {
   ...
   public:
      ...
      // output logger
      MsgLogger& Logger() const { return *fLogger; }
...
//_______________________________________________________________________
template<typename T>
inline Int_t TMVA::Tools::VerifyRange( const T& var, const T& vmin, const T& vmax )
{
...
//_______________________________________________________________________
template<typename T>
inline Bool_t TMVA::Tools::VerifyRange( TMVA::MsgLogger& mlog, const char *varstr, T& var, const T& vmin, const T& vmax )
{
...
//_______________________________________________________________________
template<typename T>
inline Bool_t TMVA::Tools::VerifyRange( TMVA::MsgLogger& mlog, const char *varstr, T& var, const T& vmin, const T& vmax, const T& vdef )
{
   // verify range and print out message
