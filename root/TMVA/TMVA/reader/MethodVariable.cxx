// @(#)root/tmva $Id: MethodVariable.cxx,v 1.7 2008/07/12 20:21:39 stelzer Exp $
...
//_______________________________________________________________________
TMVA::MethodVariable::MethodVariable( const TString& jobName,
   ...
   : TMVA::MethodBase( jobName, methodTitle, theData, theOption, theTargetDir )
{
   ...
   if (-1 == DataInfo().FindVarIndex(GetOptions()) ) {
      fLogger << kFATAL << "variable " << GetOptions() << " not found in dataset info" << Endl;
   }
   else {
...
//_______________________________________________________________________
TMVA::MethodVariable::MethodVariable( DataSetInfo& dsi, 
                                      const TString& theWeightFile,  
                                      TDirectory* theTargetDir )
   : TMVA::MethodBase( dsi, theWeightFile, theTargetDir )
{
   // standard constructor from reader
}
