// @(#)root/tmva $Id: MethodCommittee.cxx,v 1.7 2008/07/06 21:29:33 stelzer Exp $ 
...
//_______________________________________________________________________
TMVA::MethodCommittee::MethodCommittee( TString jobName, TString methodTitle, DataSetInfo& dsi, 
                                        TString theOption, TDirectory* theTargetDir )
   : TMVA::MethodBase( jobName, methodTitle, dsi, theOption, theTargetDir )
{
   // constructor
...
Double_t TMVA::MethodCommittee::AdaBoost( TMVA::MethodBase* method )
{
   ...
   if (Data()->GetNTrainingEvents()) fLogger << kFATAL << "<AdaBoost> Data().TrainingTree() is zero pointer" << Endl;
