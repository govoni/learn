// @(#)root/tmva $Id: VariableNormalizeTransform.h,v 1.1 2008/07/20 20:44:28 stelzer Exp $
...
namespace TMVA {
   ...
   public:
      ...
      VariableNormalizeTransform(const std::vector<TMVA::VariableInfo>&);
   ...
   private:
      ...
      Float_t*           fMin[2];     //! Min of source range
      Float_t*           fMax[2];     //! Max of source range
