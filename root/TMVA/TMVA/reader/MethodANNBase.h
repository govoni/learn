// @(#)root/tmva $Id: MethodANNBase.h,v 1.3 2007/07/28 13:07:33 stelzer Exp $
...
namespace TMVA {
   ...
   public:
      ...
      MethodANNBase( TString jobName, TString methodTitle, DataSetInfo& theData, 
                     TString theOption, TDirectory* theTargetDir );
      
      MethodANNBase( DataSetInfo& theData, TString theWeightFile, 
