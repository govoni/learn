// @(#)root/tmva $Id: MethodLikelihood.h,v 1.5 2008/06/26 23:01:52 stelzer Exp $ 
...
namespace TMVA {
   ...
   private:
      ...
      UInt_t                   fDropVariable;  // for ranking test
      ...
      PDF*               fDefaultPDF; //pdf that contains default definitions
