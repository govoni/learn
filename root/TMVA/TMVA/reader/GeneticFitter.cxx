// @(#)root/tmva $Id: GeneticFitter.cxx,v 1.3 2008/07/23 12:41:48 speckmayer Exp $ 
...
void TMVA::GeneticFitter::DeclareOptions() 
{
   ...
   DeclareOptionRef( fSaveBestFromCycle=10,     "SaveBestCycle", 
                     "Saves the best n results from each cycle. They are included in the last cycle. The value should be set to at least 1." );  
