// @(#)root/tmva $Id: MethodRuleFit.cxx,v 1.8 2008/07/23 16:49:04 helgevoss Exp $
...
//_______________________________________________________________________
TMVA::MethodRuleFit::MethodRuleFit( TString jobName, TString methodTitle, DataSetInfo& theData, 
...
void TMVA::MethodRuleFit::InitEventSample( void )
{
   ...
   if (Data()->GetNEvents()==0) fLogger << kFATAL << "<Init> Data().TrainingTree() is zero pointer" << Endl;
