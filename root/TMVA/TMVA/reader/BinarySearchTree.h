// @(#)root/tmva $Id: BinarySearchTree.h,v 1.5 2008/07/20 20:44:28 stelzer Exp $    
...
namespace TMVA {
   ...
   public:
      ...
      virtual Node * CreateNode(UInt_t size=0) {
         if(size==0)
            return new BinarySearchTreeNode();
         return new BinarySearchTreeNode( new TMVA::Event(size) );
      }
