// @(#)root/tmva $Id: DecisionTree.cxx,v 1.8 2008/08/04 22:01:52 helgevoss Exp $
...
TMVA::DecisionTree::DecisionTree( const DecisionTree &d):
   ...
   fMyTrandom      (new TRandom2(0)), // needs fix
...
//_______________________________________________________________________
Int_t TMVA::DecisionTree::BuildTree( const vector<TMVA::Event*> & eventSample,
...
void TMVA::DecisionTree::PruneTreeCC()
{
   ...
   bla=NULL;
   CCPruner* pruneTool = new CCPruner(this, bla , fSepType);
