// @(#)root/tmva $Id: MethodPDERS.cxx,v 1.8 2008/07/06 21:29:33 stelzer Exp $
...
//_______________________________________________________________________
TMVA::MethodPDERS::MethodPDERS( TString jobName, TString methodTitle, DataSetInfo& theData, 
...
void TMVA::MethodPDERS::Train( void )
{
   ...
   CreateBinarySearchTrees( Types::kTraining );
...
//_______________________________________________________________________
void TMVA::MethodPDERS::CreateBinarySearchTrees( Types::ETreeType type ) 
{
   ...
   fBinaryTreeS->Fill( Data()->GetEventCollection(type), 1 );
   fBinaryTreeB->Fill( Data()->GetEventCollection(type), 0 );
...
void TMVA::MethodPDERS::ReadWeightsFromStream( istream& istr)
{
   ...
   if (TxtWeightsOnly()) {
      ...
      fBinaryTreeS->SetPeriode( GetNvar() );
      fBinaryTreeB->SetPeriode( GetNvar() );
