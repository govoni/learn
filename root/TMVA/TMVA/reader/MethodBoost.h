// @(#)root/tmva $Id: MethodBoost.h,v 1.5 2008/07/12 20:21:39 stelzer Exp $   
...
namespace TMVA {
   ...
   public :
      ...
      //gives the monitoring historgram from the vector according to index of the histrogram added in the MonitorBoost function
      TH1*           GetMonitoringHist(Int_t histInd)
      {return (*fMonitorHist)[fDefaultHistNum+histInd];};

      void           AddMonitoringHist(TH1* hist)
      {return fMonitorHist->push_back(hist);};
   ...
   private :
      ...
      MethodBoost* SetStage(Types::EBoostStage stage)
      { fBoostStage=stage; return this;};
