#!/usr/bin/env python
# @(#)root/tmva $Id: CreateRootVersionRef.py,v 1.2 2008/05/27 15:44:11 andreas.hoecker Exp $
# ------------------------------------------------------------------------------ #
...
def main():
    ...
    print '</tr><tr><td></td></tr><tr><td>'            
    print '<p></p>'
    print '</ul><hr><font color="#555555">Created on %s (TMVA, 2006 - 2008)</font>' % time.ctime()
